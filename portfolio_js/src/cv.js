...
function CV() {
    ...
    return (
        <section id="cv">
        <h1 style={{  position: "relative", "left": "950px", fontSize: "60px", "paddingTop": "100px"}}>Curriculum Vitae</h1>
        <div class="row">
            <div class="column">
            ...
            <div class="column">
                <h2 class="header"> Language skills </h2>
                    <div class="text">
                        <ul>
